...
def test_gdi_fallback():
    ...
    # Test assertions - ensure both capture methods work
    assert gdi_screenshot is not None, 'GDI fallback capture should work'
...
if __name__ == '__main__':
    ...
    for f in [
        'normal_capture_test.png',
        'gdi_fallback_test.png',
        'watermark_real_test.png',
    ]:
        if os.path.exists(f):
            print(f'  - {f}')
