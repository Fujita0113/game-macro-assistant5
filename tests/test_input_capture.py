...
class TestInputCaptureManager(unittest.TestCase):
    ...
    @patch('src.core.input_capture.mouse.Listener')
    @patch('src.core.input_capture.keyboard.Listener')
    def test_start_recording_permission_error(self, mock_keyboard_listener, mock_mouse_listener):
    ...
    @patch('src.core.input_capture.mouse.Listener')
    @patch('src.core.input_capture.keyboard.Listener')
    def test_start_recording_os_error(self, mock_keyboard_listener, mock_mouse_listener):
    ...
    @patch('src.core.input_capture.mouse.Listener')
    @patch('src.core.input_capture.keyboard.Listener')
    def test_start_recording_generic_error(self, mock_keyboard_listener, mock_mouse_listener):
    ...
    def test_error_codes_format(self):
        ...
        for code in error_codes:
            with self.subTest(code=code):
                ...
                self.assertTrue(code.endswith("001") or code.endswith("002") or 
                              code.endswith("003") or code.endswith("004"))
